...
def kar_keszites():
    ...
    irdki(f"Üdv a játékban, {jatekos.name}. Ajánljuk, hogy a játék elején növeld a képernyőd méretét a neked megfelelőre.\n", 2.5)
    irdki("Nyugi, megvárunk.", 2.5)
    os.system('cls')
